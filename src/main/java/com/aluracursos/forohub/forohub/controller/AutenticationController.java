...
import com.aluracursos.forohub.forohub.infra.security.DatosJWTToken;
...
public class AutenticationController {
    ...
    public ResponseEntity autenticarUsuario(@RequestBody @Valid
        ...
        AbstractAuthenticationToken authtoken = new UsernamePasswordAuthenticationToken(datosAutenticacionUsuario.login(),
